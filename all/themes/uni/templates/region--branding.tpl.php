<div<?php print $attributes; ?>>
  <div<?php print $content_attributes; ?>>
    <div class="branding-data clearfix">
      <div class="logo-img">
        <a title="University of Northern Iowa" rel="home" href="http://www.uni.edu/">
        <img id="logo" alt="University of Northern Iowa" src="<?php global $base_path; print $base_path.drupal_get_path('theme', 'uni'); ?>/css/images/uni-logo.png">
        </a>   
      </div>
